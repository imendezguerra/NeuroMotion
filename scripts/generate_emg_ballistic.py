...
if __name__ == '__main__':
    ...
    parser.add_argument('--dur_rest_s', default=6, type=float, help='Duration in seconds of the rest period')
    parser.add_argument('--reps', default=6, type=int, help='Number of ballistic repetitions')
